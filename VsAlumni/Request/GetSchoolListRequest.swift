...
class GetSchoolListRequest{
    ...
    static func call_request (param : [String : Any],completion_handler : @escaping(String) -> ()) {
        ...
        KRProgressHUD.show()
        print("GetSchoolListRequest()",get_url())
    ...
    private static func get_url() -> String {
        ...
        return String (format:  "%@location/get-school-list-by-keyword",Constant.BaseUrl as! CVarArg )
