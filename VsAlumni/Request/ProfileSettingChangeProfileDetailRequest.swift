//
//  ProfileSettingChangeProfileDetailRequest.swift
//  VsAlumni
//
...
class ProfileSettingChangeProfileDetailRequest {
    ...
    private static func get_url() -> String{
        ...
        return String(format: "%@profile/change-profile-picture", Constant.BaseUrl as! CVarArg )
    }
